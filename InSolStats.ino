...
// take care: we now evaluate insolRef >> this is not calibrated agains Pyranometer

const char* INSOL_FILENAME = "INSOL.DAT"; // here we log the measured insolation energy (power * time)

// we catch longest daylight period june 04.00 - 19.00 >> span = 04.00 - 19.00 hour, plus safety margin of 1 hour on both sides = 18 slots
...
char buff[140];
    ...
    if (file) {
      sprintf(buff, "%d-%02d-%02d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%04d;%05d",
